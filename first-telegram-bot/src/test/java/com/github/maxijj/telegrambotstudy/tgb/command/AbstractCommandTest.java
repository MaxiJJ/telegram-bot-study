...
abstract class AbstractCommandTest {
    ...
    protected TgbFirstBot tgbFirstBot = Mockito.mock(TgbFirstBot.class);
    protected SendBotMessageService sendBotMessageService = new SendBotMessageServiceImpl(tgbFirstBot);
    ...
    public void shouldProperlyExecuteCommand() throws TelegramApiException {
        ...
        Mockito.verify(tgbFirstBot).execute(sendMessage);
    }
